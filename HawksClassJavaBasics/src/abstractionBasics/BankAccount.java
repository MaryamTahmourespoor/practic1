...
//			} 
	...
	// you can not have implementation for your methods in an interface unless its static or default
	// you can implement multiple interface in one class
	// you are basically overriding the methods when you are providing implementation
