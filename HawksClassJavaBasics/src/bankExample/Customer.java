...
public class Customer {
	...
	// personal Info
		...
		public Customer(String newFirstName, String newLastName, int newAge, int newSSN, String newDOB,
		int phoneNumber,String newEmail, Address newAdd, String newAccountPass, int newCheckingAccNum) {
