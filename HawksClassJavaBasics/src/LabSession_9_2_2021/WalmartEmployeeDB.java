package LabSession_9_2_2021;
	...
	public String addEmployee(Employee emp) {
		...
		if (localCount > employees.length - 1) {
			return "Error : the system is full and can accept new Employees";
		}
		if (globalCount > allEmployees.length - 1) {
			return "Error : the gGlobal System is full and can accept new Employees";
		}	
	...
	public void printBranchEmployees() {
	 ...
	 System.out.println("********** End of Branch Employees ************");
	}
	//************************************************************//
//	public class WalmartEmployeeDB { // how many employees we have in total in all of Walmarts
//		// we keep track employees of each branch
//		// we also keep a list all of the employees of all of the branches // this is a dynamic list that will be initialized for each branch / object of
//		// this class
//		private Employee[] employees; // this is a count of all of the employees of the branch
//		private int localCount; // this is a static count of all of the branches employees
//		private static int globalCount = 0; // this is a list of all of the employees of all of the branches
//		private static Employee[] allEmployees = new Employee[1000]; // branch name
//		private final String branchName; public WalmartEmployeeDB(String branchName) {
//		super();
//		this.employees = new Employee[100];
//		this.localCount = 0;
...
//		employees[localCount++] = emp; // add the employee to the global list / and increase the global count
//		allEmployees[globalCount++] = emp; System.out.println("Employee ADDED to (" + branchName + "): " + emp);
//		return true;
